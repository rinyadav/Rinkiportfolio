      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-6xl xl:text-8xl font-bold mb-6 max-sm:text-4xl">
            Hi, I'm <span className="text-primary">Rinki Yadav</span>
          </h1>
          ...
          <div className="flex gap-6 justify-center mt-8">
            <a
              href="https://github.com/rinkiyadav"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/rinkiyadav"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors"
              aria-label="LinkedIn"
            ...
            <a
              href="mailto:rinki191006@gmail.com"
              className="text-muted-foreground hover:text-primary transition-colors"
              aria-label="Email"
            >
